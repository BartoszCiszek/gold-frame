...
type CountUpProps = {
  ...
  className?: string;
  startWhen?: boolean; // whether to auto-start when in view
...
export default function CountUp({
  ...
  // tune spring based on duration (longer duration -> looser)
  ...
  // initial render: set starting value to from (or to if direction down)
  useEffect(() => {
    if (ref.current) {
  ...
  // subscribe to spring changes and write formatted value to DOM node
  useEffect(() => {
