...
type Service = {
  ...
  videoSrc?: string; // Opcjonalne wideo w tle przy hover
};

// Dane usług (zaktualizowane o ikony z react-icons)
const SERVICES: Service[] = [
  {
    ...
    icon: <FiScissors />,
    videoSrc: "/videos/placeholder-vertical.mp4", // Podmień na swoje wideo
  },
  {
    id: "s2",
    ...
    icon: <FiFilm />,
    videoSrc: "/videos/placeholder-vertical.mp4",
  },
  {
    id: "s3",
    ...
    icon: <FiMonitor />,
    // videoSrc: brak wideo, karta będzie miała tylko efekt graficzny
  },
  {
    id: "s4",
...
const ServiceCard = ({ service, index }: { service: Service; index: number }) => {
  ...
  const handleMouseLeave = () => {
    if (videoRef.current) {
      ...
      videoRef.current.currentTime = 0; // Reset wideo
    }
  };
  ...
  return (
    ...
    >
      {/* 1. Neonowy Border na Hover (Gradient) */}
  ...
  return (
    <section id="services" className="relative py-20 md:py-32 bg-black overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-black text-white uppercase mb-4 tracking-tight font-display">
          ...
          <div className="h-1 w-24 bg-gradient-to-r from-cyan-500 to-purple-600 mx-auto mt-8 rounded-full" />
        </motion.div>
